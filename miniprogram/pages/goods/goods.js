...
Page({
    onLoad: function (options) {
        ...
        console.log('收到',options)
        this.setData({
            minPrice:parseInt(options.minPrice),
            deliveryPrice:parseInt(options.deliveryPrice),
            name:options.name,
            time:options.time,
    ...
    payDesc() {
        if (this.data.totalPrice === 0) {
            console.log('查',this.data.minPrice)
    ...
    pay() {
        ...
        var myDate = new Date();
        console.log('目前的地址',this.data.addressName)
       wx.cloud.callFunction({
            ...
            data:{
                ...
                price:this.data.totalPrice+this.data.deliveryPrice,
                goods:this.data.carArray,
